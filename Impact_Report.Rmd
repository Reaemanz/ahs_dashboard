...
# Fill NAs in Control for Kisoro & Rukunjiri, Cohort 2019, Year "Base"
Mapping_2020_Controls_to_Mitooma_Yr2 <- Mapping_2020_Controls_to_Kan_Yr2 %>%
...
Kanungu_Controls_2021 <- Mapping_2020_Controls_to_Mitooma_Yr2 %>%
  filter(District == "Kanungu", Cohort == "2018", Year == "Year 3", !is.na(Control)) %>%
  select(`Income Streams`, Control) %>%
  rename(Control_Kanungu_2021 = Control) %>% view()

# Fill NAs in Control for Kisoro & Rukunjiri, Cohort 2019, Year "Base"
Mapping_2021_Base_Controls_to_kanungu_Yr3 <- Mapping_2020_Controls_to_Mitooma_Yr2 %>%
